...
public class Video extends TableImpl<VideoRecord> {
    ...
    /**
     * The column <code>public.video.category</code>.
     */
    public final TableField<VideoRecord, String> CATEGORY = createField(DSL.name("category"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.video.sum_of_likes</code>.
     */
    public final TableField<VideoRecord, Long> SUM_OF_LIKES = createField(DSL.name("sum_of_likes"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.video.url</code>.
     */
    public final TableField<VideoRecord, String> URL = createField(DSL.name("url"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.video.views</code>.
     */
    public final TableField<VideoRecord, Long> VIEWS = createField(DSL.name("views"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.video.id_account</code>.
     */
    public final TableField<VideoRecord, Long> ID_ACCOUNT = createField(DSL.name("id_account"), SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<VideoRecord, ?>> getReferences() {
        return Arrays.asList(Keys.VIDEO__FKPOK81KP9SJ5A1O8P714N8NP8Y);
    }
    ...
    public UserAccountPath userAccount() {
        if (_userAccount == null)
            _userAccount = new UserAccountPath(this, Keys.VIDEO__FKPOK81KP9SJ5A1O8P714N8NP8Y, null);
    ...
    public TbLikePath tbLike() {
        if (_tbLike == null)
            _tbLike = new TbLikePath(this, null, Keys.TB_LIKE__FKT3W1U0JTEU6PIV1Y1CTPQR8VW.getInverseKey());
