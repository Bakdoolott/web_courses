...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.id_account</code>.
     */
    public final TableField<UsersRecord, Long> ID_ACCOUNT = createField(DSL.name("id_account"), SQLDataType.BIGINT, this, "");
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UKHDSJM6L3LUDH1INV75NOEDBPM);
    }

    @Override
    public List<ForeignKey<UsersRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USERS__FKJUFG4PSSCKH87O76NF7Y52GRA);
    }
    ...
    public UserAccountPath userAccount() {
        if (_userAccount == null)
            _userAccount = new UserAccountPath(this, Keys.USERS__FKJUFG4PSSCKH87O76NF7Y52GRA, null);
