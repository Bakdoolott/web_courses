...
public class Playlist extends TableImpl<PlaylistRecord> {
     ...
     */
    public final TableField<PlaylistRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.playlist.id_account</code>.
     */
    public final TableField<PlaylistRecord, Long> ID_ACCOUNT = createField(DSL.name("id_account"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.playlist.id_account_course</code>.
     */
    public final TableField<PlaylistRecord, Long> ID_ACCOUNT_COURSE = createField(DSL.name("id_account_course"), SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<PlaylistRecord, ?>> getReferences() {
        return Arrays.asList(Keys.PLAYLIST__FKLAD3BXY6MLCF07CQRN8L4EO24, Keys.PLAYLIST__FKOFEGJWRUBYFN8VODKWVX1SN2D);
    }
    ...
    public UserAccountPath userAccount() {
        if (_userAccount == null)
            _userAccount = new UserAccountPath(this, Keys.PLAYLIST__FKLAD3BXY6MLCF07CQRN8L4EO24, null);
    ...
    /**
     * Get the implicit join path to the <code>public.account_course</code>
     * table.
     */
    public AccountCoursePath accountCourse() {
        if (_accountCourse == null)
            _accountCourse = new AccountCoursePath(this, Keys.PLAYLIST__FKOFEGJWRUBYFN8VODKWVX1SN2D, null);
